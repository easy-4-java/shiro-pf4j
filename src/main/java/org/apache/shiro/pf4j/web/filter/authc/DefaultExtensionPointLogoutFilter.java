...
/**
 * Default concrete implementation of {@link AbstractExtensionPointLogoutFilter}.
 * Resolves the plugin ID and extension ID from request headers, parameters, or cookies
 * using {@link ExtensionPointUtils} and delegates logout to the plugin's authentication extension point.
 *
 * @author [@Loong Wan](https://github.com/loong10k)
 * @since 3.0.0
 * @see AbstractExtensionPointLogoutFilter
 * @see ExtensionPointUtils#getPluginId
 * @see ExtensionPointUtils#getExtensionId
 */
public class DefaultExtensionPointLogoutFilter extends AbstractExtensionPointLogoutFilter {
