...
[![Java](https://img.shields.io/badge/Java-17-orange)](https://github.com/easy-4-java/shiro-pf4j) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
| easy4j dependency | `io.github.easy4j:shiro-biz` (`2.0.x.x.20260630-SNAPSHOT`) |
...
```groovy
implementation 'io.github.easy4j:shiro-pf4j:2.0.x.x.20260630-SNAPSHOT'
```
